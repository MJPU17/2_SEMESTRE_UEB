...
public class VistaConsola {
	...
	public void mostrarInformacionSinSalto(String informacion) {
	...
	public double leerDecimal(String mensaje) {
		...
		while(true) {
			try {
				...
				BigDecimal aux=sc.nextBigDecimal();
				if(aux.compareTo(new BigDecimal(max.toString()))==1) throw new LimiteExcedidoException();
				
				else if(aux.compareTo(BigDecimal.ZERO)==-1) throw new NumeroNegativoException();
